 ...
 */
final class Version20220211124440 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE habitacion ADD descripcion VARCHAR(200) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE habitacion DROP descripcion');
