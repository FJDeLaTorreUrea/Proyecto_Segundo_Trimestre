 ...
 */
final class Version20220213204040 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reserva ADD adultos INT NOT NULL, ADD menores INT NOT NULL');
    }
